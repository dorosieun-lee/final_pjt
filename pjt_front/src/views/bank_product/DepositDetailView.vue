...
onMounted(() => {
  ...
  axios({
    method: 'get',
    url: `${store.API_URL}/api/v1/bank-products/deposit-detail/${fin_prdt_cd}`,
    headers: {
...
const check_likes_user = function () {
  axios({
    method: 'get',
    url: `${store.API_URL}/api/v1/bank-products/${route.params.id}/likes-check/`,
    headers: {
      Authorization: `Token ${user_store.token}`
    }
  })
...
const onClick = function () {
  axios({
    method: 'post',
    url: `${store.API_URL}/api/v1/bank-products/${route.params.id}/likes-deposit/`,
    headers: {
      Authorization: `Token ${user_store.token}`
    }
  })
