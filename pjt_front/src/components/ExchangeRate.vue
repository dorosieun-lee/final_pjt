...
// 추가하고 싶은 기능
// 화폐 선택에 국기 이미지 추가
// 계산기 아래에 최근 30일 환율 차트와 등락 비율 추가
...
<template>
    <div class="outer-box text-center p-4">
        <h3 class="fw-bold">환율계산기</h3>
        <p class="mb-0">매매기준율로 계산됩니다.</p>
        <div class="container">
            <div class="row">
        ...
        <!-- <div v-show="warningMsg" style="color: red;">{{ warningMsg }}</div> -->
...
.btn-calc {
    background-color: rgb(64, 184, 248);
    color: white;
}
</style>
