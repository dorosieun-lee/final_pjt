...
<template>
    <div class="container text-center">
        ...
        <div class="row col-lg-7">
            ...
            <button @click="selectedLocation(address)" class="btn btn-primary col-lg-4">선택한 지역으로 이동</button>
        </div>
        <div class="row col-lg-3">
            ...
            <button @click="searchBank(bank)" class="btn btn-primary col-sm-4 col-lg-6">은행 검색</button>
            </div>
        </div>
        <Map ref="mapRef"/>
    </div>
