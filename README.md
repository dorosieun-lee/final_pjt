...
| 16 | 은행 검색 지도 | API를 활용하여 Kakao 맵 화면 구현   | ⭐⭐⭐⭐⭐     |
| 17 |  | 키워드에 맞는 검색 결과 구현 | ⭐⭐⭐⭐⭐     |
| 18 |  | 카카오 맵 마커에 장소 정보 표시  | ⭐⭐⭐⭐⭐     |
| 19 | 커뮤니티 | 게시글 및 댓글 CRUD 기능 구현 | ⭐⭐⭐⭐⭐     |
| 20 |  | 게시글 검색 기능 구현  | ⭐⭐⭐⭐⭐     |
| 21 |  | 게시글을 카테고리에 따라 작성자표시를 다르게 구현 | ⭐⭐⭐⭐⭐     |
| 22 | 유저 프로필 | 회원 정보 수정, 비밀번호 변경 기능 | ⭐⭐⭐⭐⭐     |
| 23 |  | 회원 탈퇴 기능 | ⭐⭐⭐⭐⭐     |
| 24 |  | 본인이 작성한 게시글 조회 | ⭐⭐⭐⭐⭐     |
| 25 |  | 관심상품 등록한 예/적금 상품 조회 | ⭐⭐⭐⭐⭐     |
| 26 |  | 유저정보에서 입력 받은 정보를 기반으로 상품 추천 알고리즘 | ⭐⭐⭐⭐⭐     |
| 27 |  | 차트 라이브러리 통해 금리 비교  | ⭐⭐⭐⭐⭐     |
